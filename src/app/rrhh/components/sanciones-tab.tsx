...
import { AlertTriangle, Plus, Construction } from 'lucide-react'

export function SancionesTab() {
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-base font-medium text-gray-900">Sanciones y Apercibimientos</h2>
          <p className="text-sm text-gray-500">Registro disciplinario</p>
        </div>
      ...
      <div className="flex flex-col items-center justify-center py-16 border border-dashed border-gray-300 rounded-lg bg-gray-50">
        ...
        <p className="text-sm text-gray-500 text-center max-w-md">
          El módulo de Sanciones está siendo implementado.
          Próximamente podrás gestionar el registro disciplinario del personal.
        </p>
      </div>
    </div>
  )
